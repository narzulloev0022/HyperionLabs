...
const translations = {
  en: {
    ...
    cofounderTitle: "Technical Co-Founder",
    cofounderText: "Looking for: AI/ML engineer, researcher, or fullstack dev with passion for healthcare.",
    joinUs: "Join us",
    cofounderTitle2: "Business / Commercial Co-Founder",
    cofounderText2: "Looking for: GTM expert, investor relations, or healthcare partnerships lead.",
    connect: "Connect",
  ...
  ru: {
    ...
    linkedin: "LinkedIn",
    cofounderLabel: "Co-Founder",
    cofounderTitle: "Технический кофаундер",
    cofounderText: "Ищем: AI/ML инженера, исследователя или фулстек-разработчика с интересом к healthcare.",
    joinUs: "Присоединиться",
    cofounderTitle2: "Бизнес / коммерческий кофаундер",
    cofounderText2: "Ищем: GTM-эксперта, специалиста по инвестициям или лидера в healthcare-партнёрствах.",
    connect: "Связаться",
